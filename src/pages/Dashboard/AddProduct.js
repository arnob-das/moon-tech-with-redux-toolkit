    ...
    <div className='flex justify-center items-center h-full '>
      ...
      >
        <div className='flex flex-col w-full max-w-xs'>
          ...
          <input required={true} type='text' id='model' {...register("model")} />
        </div>
        <div className='flex flex-col w-full max-w-xs'>
          <label className='mb-2' htmlFor='image'>
            Image
          </label>
          <input required={true} type='text' name='image' id='image' {...register("image")} />
        </div>
        ...
        <div className='flex flex-col w-full max-w-xs'>
          ...
          <input required={true} type='text' name='price' id='price' {...register("price")} />
        </div>
        <div className='flex flex-col w-full max-w-xs'>
          <label className='mb-2' htmlFor='rating'>
            Rating
          </label>
          <input required={true} type='text' name='rating' id='rating' {...register("rating")} />
        </div>
